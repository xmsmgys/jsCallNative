...
let initMode = function () {
    ...
    exec('cd ../build/jsb-link/res/ && mkdir import-temp && cp -r import import-temp/import && rm -rf import && mv import-temp import');
    zipFile('../build/jsb-link/res/import', () => {
        exec('rm -rf ../build/jsb-link/res/import');
        exec(`cp -r ../build/jsb-link/res/import.zip  ${copyPath + mode_name}/res`);
